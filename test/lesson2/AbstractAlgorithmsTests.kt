...
abstract class AbstractAlgorithmsTests {
    ...
    fun optimizeBuyAndSell(optimizeBuyAndSell: (String) -> Pair<Int, Int>) {
        ...
        assertEquals(154 to 486, optimizeBuyAndSell("input/buysell_in4.txt"))
        try {
    ...
    fun longestCommonSubstring(longestCommonSubstring: (String, String) -> String) {
        ...
        assertEquals("сок шур", longestCommonSubstring("шалашилисок шуркамыши", "каристок шуралинкс"))
...
Но вреден север для меня
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(8894, calcPrimesNumber(92100))
        assertEquals(308163, calcPrimesNumber(4381871))
    }
    ...
    fun baldaSearcher(baldaSearcher: (String, Set<String>) -> Set<String>) {
        ...
        assertEquals(
            setOf("балда", "тииваи"),
            baldaSearcher("input/balda_in2.txt", setOf("балда", "ваиав", "тииваи"))
        )
        assertEquals(
            setOf("КОЖА", "КОРОВА", "РИЗАКОР"),
            baldaSearcher("input/balda_in4.txt", setOf("КОЖА", "КОРОВА", "ШАЛАШ", "ПОРОП", "РЭР", "РИЗАКОР", "ЛОГ"))
        )
        assertEquals(
            setOf("ЭТОПРОСТОТЕСТНАДЛИННОЕСЛОВО"),
            baldaSearcher(
                "input/balda_in5.txt",
                setOf("КОЖА", "ЭТОПРОСТОТЕСТНАДЛИННОЕСЛОВО", "ПОРОП", "РЭР", "РИЗАКОР", "ЛОГ")
            )
        )
        assertEquals(
            setOf(
